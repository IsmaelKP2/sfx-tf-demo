...
You should be able to see a Google spreadsheet that looks similar to the screenshotted example below: <!-- ![Screenshot_Instance_Sheet](../images/access_aws_instance/access_sheet.png) -->
<br><img src="../images/access_aws_instance/access_sheet.JPG" width=40% height=40%>


2. In the first column with the title *Name of Attendee* locate your name. **Find your personal access link to the instance on the right of your name** and use it to reach the login page of Splunk Enterprise. It looks like this: <!--  ![Screenshot_Login](../images/access_aws_instance/login.png) -->
<br><img src="../images/access_aws_instance/login.JPG" width=60% height=60%>
...
<br><img src="../images/access_aws_instance/home_view.JPG" width=60% height=60%>
