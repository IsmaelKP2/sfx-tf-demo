...
The quantity of each Instance deployed is also controlled here so you can deploy between 0 & 3 of each type, but you should always deploy at least 1 collector.
